      ...
      {navigation.map((item) => {
        ...
        return (
          <a
            key={item.label}
            href={`#${item.id}`}
            className="group relative inline-flex items-center gap-0 rounded-md px-2 py-1 text-sm font-medium text-slate-300 transition-colors hover:text-white focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none active:text-white [@media(min-width:48rem)_and_(max-width:50rem)]:px-0.5"
