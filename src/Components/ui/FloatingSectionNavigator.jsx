    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className={`z-50 flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/90 text-white shadow-[0_0_25px_rgba(59,130,246,0.25)] backdrop-blur transition-colors duration-300 hover:-translate-y-1 hover:border-blue-600 hover:bg-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 focus-visible:outline-none active:bg-blue-600 sm:h-12 sm:w-12 md:h-14 md:w-14 lg:h-16 lg:w-16 ${positionClassName}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-5 w-5 transition-transform duration-300 sm:h-6 sm:w-6 md:h-7 md:w-7 lg:h-8 lg:w-8 ${
