      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col-reverse items-center gap-10 px-6 py-24 md:flex-row md:items-center md:justify-between md:gap-16 lg:px-8">
        ...
        >
          <div className="relative">
            ...
            <motion.div
              className="relative h-36 w-36 overflow-hidden rounded-full border-4 border-blue-500 bg-slate-900 shadow-[0_0_60px_rgba(59,130,246,0.35)] sm:h-80 sm:w-80 lg:h-96 lg:w-96"
              initial={
                shouldReduceMotion
                  ? false
                  : {
